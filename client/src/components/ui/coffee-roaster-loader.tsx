  ...
  return (
    <div className={`${className} relative`}>
      ...
      >
        ...
        <g>
          {/* Bean 1 - Path 1 */}
          <ellipse cx="48" cy="80" rx="2" ry="3" fill="#a0522d">
            <animateMotion
              dur="2.5s"
              repeatCount="indefinite"
              begin="0.1s"
              path="M 0 0 A 50 32 0 0 1 -21 -36 L -1 -3"
            />
          </ellipse>
          ...
          <ellipse cx="48" cy="80" rx="2" ry="3" fill="#8b4513">
            <animateMotion
              ...
              repeatCount="indefinite"
              begin="0.3s"
              path="M -4 -3 A 50 32 0 0 1 -15 -34 L -7 -8"
            />
          </ellipse>
          ...
          <ellipse cx="48" cy="80" rx="2" ry="3" fill="#a0522d">
            <animateMotion
              ...
              repeatCount="indefinite"
              begin="0.7s"
              path="M 2 -1 A 50 32 0 0 1 -16 -38 L 3 -1"
            />
          </ellipse>
          ...
          <ellipse cx="48" cy="80" rx="2" ry="3" fill="#8b4513">
            <animateMotion
              ...
              repeatCount="indefinite"
              begin="1.2s"
              path="M 5 -1 A 50 32 0 0 1 -15 -37 L 6 -2"
            />
          </ellipse>
          ...
          <ellipse cx="48" cy="80" rx="2" ry="3" fill="#a0522d">
            <animateMotion
              ...
              repeatCount="indefinite"
              begin="0.9s"
              path="M 1 0 A 50 32 0 0 1 -18 -37 L 7 -2"
            />
          </ellipse>
          ...
          <ellipse cx="48" cy="80" rx="2" ry="3" fill="#8b4513">
            <animateMotion
              ...
              repeatCount="indefinite"
              begin="1.8s"
              path="M 4 -3 A 50 32 0 0 1 -20 -39 L -10 -8"
            />
          </ellipse>
